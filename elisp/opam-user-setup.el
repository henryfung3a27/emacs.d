...
;; ## added by OPAM user-setup for emacs / tuareg ## 1a1fa255a7b030439b34d235ce7b13cc ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/core/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
